...
from .stream_type import StreamtType
...
class Stream(models.Model):
  ...
  stream_type = models.CharField(max_length=255, choices=StreamtType.choices())
  remove_text = models.TextField(null=True, max_length=1023, default="")
  remove_regex = models.TextField(null=True, max_length=1023, default="")
  replace_text = models.TextField(null=True, max_length=1023, default="")
  join_string = models.TextField(null=True, max_length=1023, default="")
  extract_first_n_lines = models.IntegerField(default=1)
  extract_nth_line = models.TextField(null=True, default="")
