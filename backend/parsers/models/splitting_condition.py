...
class SplittingCondition(models.Model):
    ...
    #consecutive_page_splitting_rule = models.ForeignKey(
        #"ConsecutivePageSplittingRule", on_delete=models.CASCADE, related_name="consecutive_page_splitting_rules", null=True)
    #last_page_splitting_rule = models.ForeignKey(
        #"LastPageSplittingRule", on_delete=models.CASCADE, related_name="last_page_splitting_rules", null=True)
