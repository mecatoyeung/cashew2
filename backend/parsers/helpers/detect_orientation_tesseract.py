...
def detect_orientation_tesseract(document, page_num, pre_processing, last_preprocessing=None):
    ...
    try:
        ...
        if osd["orientation"] == 90 or osd["orientation"] == 270:
            pass
        elif osd["orientation_conf"] < pre_processing.orientation_detection_tesseract_confidence_above:
            osd = {"orientation": 0}
