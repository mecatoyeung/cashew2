...
export default function Parsers() {
  ...
  const addOrientationDetectionBtnClickHandler = () => {
    router.push("/admin/parsers/" + parserId + "/preprocessings/addOrientationDetection/");
  }

  const addThresholdBinarizationBtnClickHandler = () => {
    router.push("/admin/parsers/" + parserId + "/preprocessings/addThresholdBinarization/");
  }

  const modifyBtnClickHandler = (preProcessings) => {
    router.push(
      "/admin/parsers/" + parserId + "/preprocessings/" + preProcessings.id + "/"
    );
  };
