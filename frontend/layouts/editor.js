      ...
      <div className={styles.container}>
        <div className={styles.editorWrapper}>
          <div
            ...
            style={{ width: openSidebar ? '279px' : 0 }}
          >
            <div className={styles.parsingRulesHeader}>Data Parsing Rules</div>
            ...
            <div className={styles.parsingRulesFooter}>
              <Link href={'/admin/parsers/' + parserId + '/rules'}>
                &#60; Exit Parsing Rules Editor
              </Link>
            </div>
          </div>
          <div
            className={styles.workbenchWrapper}
            style={{ width: openSidebar ? 'calc(100% - 280px)' : '99%' }}
          >
            {children}
          </div>
        </div>
        <div
          className={styles.sidebarSizeControlDiv}
          style={{ left: openSidebar ? '225px' : '10px' }}
        >
          {openSidebar && (
