                ...
                >
                  ...
                  >
                    <ul className={workspaceLayoutStyles.sideNavUl}>
                      ...
                      <Link
                        href={"/workspace/parsers/" + parserId + "/sources"}
                      >
                        <li>Sources</li>
                      </Link>
                      ...
                      <Link
                        href={
                          "/workspace/parsers/" + parserId + "/preprocessings"
                        }
                      >
                      ...
                      {parser.type == "LAYOUT" && (
                        <Link
                          href={"/workspace/parsers/" + parserId + "/aichat"}
                        >
                          <li>AI Chat</li>
                        </Link>
                      )}
                      <Link
                        href={"/workspace/parsers/" + parserId + "/splitting"}
                      >
                        <li>Splitting</li>
                      </Link>
                      ...
                      {parser.type == "LAYOUT" && (
                        <Link
                          href={
                            "/workspace/parsers/" + parserId + "/integrations"
                          }
                        >
                          <li>Integrations</li>
                        </Link>
                      ...
                      <Link
                        href={"/workspace/parsers/" + parserId + "/statistics"}
                      >
                        <li>Statistics</li>
                      </Link>
                      <Link
                        href={"/workspace/parsers/" + parserId + "/settings"}
                      >
                        <li>Settings</li>
                      </Link>
                    </ul>
